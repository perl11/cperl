...
wild, but not future variants.  Calls C<warn_security("metasploit
reverse shell payload")>, but do not protect against it. This warning
is thrown even without C<-w>.
...
The new C<S security> warning "metasploit reverse shell payload" was added,
