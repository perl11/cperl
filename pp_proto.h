...
PERL_CALLCONV OP *Perl_pp_int_complement(pTHX);
...
PERL_CALLCONV OP *Perl_pp_str_concat(pTHX);
PERL_CALLCONV OP *Perl_pp_str_delete(pTHX);
PERL_CALLCONV OP *Perl_pp_str_exists(pTHX);
PERL_CALLCONV OP *Perl_pp_str_helem(pTHX);
PERL_CALLCONV OP *Perl_pp_str_length(pTHX);
...
PERL_CALLCONV OP *Perl_pp_uint_lshift(pTHX);
PERL_CALLCONV OP *Perl_pp_uint_rshift(pTHX);
