...
$bits{$_}{7} = 'OPpLVAL_INTRO' for qw(aelem aslice cond_expr delete enterffi enteriter entersub enterxssub gvsv helem hslice list lvavref lvref lvrefslice multiconcat multideref oelem padav padhv padrange padsv padsv2 pushmark refassign rv2av rv2gv rv2hv rv2sv split);
...
$bits{$_}{6} = 'OPpPAD_STATE' for qw(lvavref lvref padav padhv padsv padsv2 pushmark refassign);
...
@{$bits{padsv2}}{5,4,0} = ($bf[7], $bf[7], $bf[0]);
...
our %ops_using = (
    ...
    OPpLVAL_INTRO            => [qw(aelem aslice cond_expr delete enterffi enteriter entersub enterxssub gvsv helem hslice list lvavref lvref lvrefslice multiconcat multideref oelem padav padhv padrange padsv padsv2 pushmark refassign rv2av rv2gv rv2hv rv2sv split)],
    ...
    OPpPAD_STATE             => [qw(lvavref lvref padav padhv padsv padsv2 pushmark refassign)],
