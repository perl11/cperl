                      ...
                      )
{
    ...
    char* name_start = RExC_parse;
    U32 num = 0;
    SV *sv_dat = reg_scan_name(pRExC_state, PASS1
                                            ? REG_RSN_RETURN_NULL
                                            : REG_RSN_RETURN_DATA);
    GET_RE_DEBUG_FLAGS_DECL;
		...
		{               /* (?<...>) */
            ...
            case '\'':          /* (?'...') */
                    ...
                    svname = reg_scan_name(pRExC_state,
                        PASS1    /* reverse test from the others */
                        ? REG_RSN_RETURN_NAME
                        : REG_RSN_RETURN_NULL);
            ...
            case '&':            /* (?&NAME) */
              ...
              named_recursion:
    		    ...
    		    SV *sv_dat = reg_scan_name(pRExC_state,
    		        PASS1 ? REG_RSN_RETURN_NULL : REG_RSN_RETURN_DATA);
...
#define MAX_NODE_STRING_SIZE (255-UTF8_MAXBYTES_CASE)
	    ...
	    s = (PASS1 && FOLD) ? foldbuf : STRING(REGNODE_p(ret));
