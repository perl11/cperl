...
%Modules = (
    ...
    'B::C' => {
        'DISTRIBUTION' => 'RURBAN/B-C-1.54_13.tar.gz',
        'FILES'        => q[cpan/B-C],
        'EXCLUDED'     => [
            qr{^.gdb},
            qr{^t/z_pod\.t/},
    ...
    'Cpanel::JSON::XS' => {
        'DISTRIBUTION' => 'RURBAN/Cpanel-JSON-XS-3.0218.tar.gz',
    ...
    'Scalar::Util' => {
        ...
        'DISTRIBUTION' => 'RURBAN/Scalar-List-Utils-1.45_06.tar.gz',
    ...
    'YAML::LibYAML' => {
        'DISTRIBUTION' => "RURBAN/YAML-LibYAML-0.74.tar.gz",
