...
multi-character graphemes as delimiters. cperl already fatalized with 5.26.0c.
...
points>, those can be delimiters. cperl already fatalized with 5.26.0c.
||||||| parent of c96bf7f63a... perldeprecation.pod - Fix a couple of nits
above the legal Unicode maximum| perlunicode/Beyond Unicode code
points>, those can be delimiters.
=======
above the legal Unicode maximum|perlunicode/Beyond Unicode code
points>, those can be delimiters.
>>>>>>> c96bf7f63a... perldeprecation.pod - Fix a couple of nits
...
=head3 ${^ENCODING} support in Perl 5

The special variable C<${^ENCODING}> is used to implement the
C<encoding> pragma. Setting this variable to anything other than
C<undef> was deprecated in Perl 5.22.
Setting this variable to anything other than an undefined value
throws a fatal error in Perl 5.28, but not in cperl.

Full deprecation of the variable happened in Perl 5.25.3, but this
feature is kept and was undeprecated in cperl v5.26c.

=head3 C<< B::OP::terse >>

This method, which just calls C<< B::Concise::b_terse >>, has been
deprecated, and disappeared in Perl and cperl 5.28. Please use 
C<< B::Concise >> instead.
...
printable character was deprecated in Perl 5.14, and is a fatal error
since Perl and cperl 5.28. You're recommended to just write the
intended character instead.
...
was deprecated in Perl 5.24, and is fatal as of Perl and cperl 5.28.

=head3 In XS code, use of C<to_utf8_case()>

This function has been removed as of Perl and cperl 5.28; instead convert to call
...
C<< h2xs >> for a long time. They have been removed in Perl 5.26, but kept
and fixed in cperl 5.26. F<pstruct> is needed to calculate a field offset.
