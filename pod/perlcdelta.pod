...
Add a new warnings category 'security' with a special message. A
"SECURITY: " prefix, as suffix the username, REMOTE_ADDR, full
pathname to implement a service similar to fail2ban.  Bypass
$SIG{__WARN__} handlers.  Print to STDERR and if available to syslog.
...
See L</"Detect, protect and warn against hash flood DoS">.
