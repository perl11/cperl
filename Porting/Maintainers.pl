...
%Modules = (
    ...
    'if' => {
        'DISTRIBUTION' => 'RJBS/if-0.0608.tar.gz',
        'FILES'        => q[dist/if],
    },

    'IO' => {
        'DISTRIBUTION' => 'TODDR/IO-1.38.tar.gz',
        'FILES'        => q[dist/IO/],
        'EXCLUDED'     => ['t/test.pl'],
    },
    ...
    'Net::Ping' => {
        ...
        'EXCLUDED'     => [
            qw{ README.md.PL t/600_pod.t t/601_pod-coverage.t },
        ],
    },
    ...
    'Scalar::Util' => {
        ...
        # TODO: move to dist. upstream doesnt apply any patches
