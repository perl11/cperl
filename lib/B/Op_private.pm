...
$bits{$_}{4} = 'OPpBOXRET' for qw(int_abs int_add int_aelem int_aelem_u int_divide int_eq int_ge int_gt int_le int_lt int_modulo int_multiply int_ne int_negate int_not int_postdec int_postinc int_predec int_preinc int_subtract num_add num_aelem num_aelem_u num_atan2 num_cos num_divide num_exp num_log num_multiply num_pow num_sin num_sqrt num_subtract str_aelem str_aelem_u uint_complement uint_left_shift uint_pow uint_right_shift);
...
$bits{$_}{6} = 'OPpPAD_UNBOXED' for qw(int_padsv num_padsv str_padsv uint_padsv);
...
our %ops_using = (
    ...
    OPpBOXRET                => [qw(int_abs int_add int_aelem int_aelem_u int_divide int_eq int_ge int_gt int_le int_lt int_modulo int_multiply int_ne int_negate int_not int_postdec int_postinc int_predec int_preinc int_subtract num_add num_aelem num_aelem_u num_atan2 num_cos num_divide num_exp num_log num_multiply num_pow num_sin num_sqrt num_subtract str_aelem str_aelem_u uint_complement uint_left_shift uint_pow uint_right_shift)],
    ...
    OPpPAD_UNBOXED           => [qw(int_padsv num_padsv str_padsv uint_padsv)],
