...
$bits{$_}{7} = 'OPpLVAL_INTRO' for qw(aelem aslice cond_expr delete enterffi enteriter entersub enterxssub gvsv helem hslice int_padsv list lvavref lvref lvrefslice multiconcat multideref num_padsv oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split str_padsv uint_padsv);
...
@{$bits{gv}}{6,5} = ('OPpGV_WASMETHOD', 'OPpEARLY_CV');
...
@{$bits{length}}{6,0} = ('OPpLENGTH_MAYBE_TRUEBOOL', $bf[0]);
...
our %ops_using = (
    ...
    OPpLVAL_INTRO            => [qw(aelem aslice cond_expr delete enterffi enteriter entersub enterxssub gvsv helem hslice int_padsv list lvavref lvref lvrefslice multiconcat multideref num_padsv oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split str_padsv uint_padsv)],
    ...
    OPpSTACKCOPY             => [qw(hslice kvhslice)],
...
$ops_using{OPpGV_WASMETHOD} = $ops_using{OPpEARLY_CV};
