...
two.  On code and arrays it does nothing yet, but might add type
...
within a map even only a pair.
See L<[cperl #280|https://github.com/perl11/cperl/issues/280>.
...
L<Odd number of map elements in hash assignment|perldiag/"Odd number of map elements in hash assignment">

Added a new MAPPAIR private bit to the mapwhile op when a map is assigned
to a hash, to be able to warn once per map on uneven hashmap assignments. See
L<[cperl #280|https://github.com/perl11/cperl/issues/280>.
...
Perl5 broke with L<[perl
#121292]|https://rt.perl.org/Public/Bug/Display.html?id=121292> the
documentation to match the broken implementation,
L<[cperl #269|https://github.com/perl11/cperl/issues/269> fixed both.
