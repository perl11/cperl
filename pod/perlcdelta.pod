...
=head2 Autovivified hash slice

is deprecated. Hash slices autovivify in for loops lists and as subroutine
arguments. This is a bug and will be fixed.
See L<[cperl #347]|https://github.com/perl11/cperl/issues/347> and
L<perldiag/"Autovivified hash slice is deprecated">
...
Fixed autovivifaction of hash slices in C<for> loops.
