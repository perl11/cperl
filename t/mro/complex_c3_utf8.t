...
use strict;
use warnings;
use utf8 qw( Hangul Cyrillic Mongolian );
...
ok(eq_array(
    ...
    [ qw(텟Ṱ::ᠠ) ]
), '... got the right C3 merge order for 텟Ṱ::ᠠ');
...
ok(eq_array(
    ...
    [ qw(텟Ṱ::ᶦ 텟Ṱ::Ḣ 텟Ṱ::ḡ 텟Ṱ::Ḟ 텟Ṱ::Ӭ 텟Ṱ::Ḏ 텟Ṱ::ᠠ 텟Ṱ::ḅ 텟Ṱ::ȼ) ]
...
ok(eq_array(
    ...
    [ qw(텟Ṱ::Ḵ 텟Ṱ::Ｊ 텟Ṱ::ᶦ 텟Ṱ::Ḣ 텟Ṱ::ḡ 텟Ṱ::Ḟ 텟Ṱ::Ӭ 텟Ṱ::Ḏ 텟Ṱ::ᠠ 텟Ṱ::ḅ 텟Ṱ::ȼ) ]
