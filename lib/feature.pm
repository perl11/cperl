...
our %feature_bundle = (
    ...
    "5.23"    => [qw(current_sub evalbytes fc postderef postderef_qq say shaped_arrays state switch unicode_eval unicode_strings)],
...
our @hint_bundles = qw( default 5.10 5.11 5.15 5.21 5.23 );
...
The following feature bundles are available:
  ...
  :5.24     say state switch unicode_strings
            unicode_eval evalbytes current_sub fc
            shaped_arrays postderef postderef_qq
