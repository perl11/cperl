...
it helps.
Every other dynamic languages switched in the meantime to optional typing.
No other dynamic language forced type optimizations and checkers out of core.
...
From most generic left to more specific to the left.
Contravariance enables you to use a more generic (less derived, more left) type
