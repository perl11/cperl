...
$bits{$_}{3} = 'OPpMAYBE_LVSUB' for qw(aassign aelem aelem_u akeys aslice av2arylen helem hslice keys kvaslice kvhslice multideref padav padhv pos rv2av rv2gv rv2hv substr vec);
...
our %ops_using = (
    ...
    OPpMAYBE_LVSUB           => [qw(aassign aelem aelem_u akeys aslice av2arylen helem hslice keys kvaslice kvhslice multideref padav padhv pos rv2av rv2gv rv2hv substr vec)],
