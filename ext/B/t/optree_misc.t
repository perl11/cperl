...
# -     <@> lineseq KP ->7
# 1        <;> nextstate(main 1612 optree_misc.t:25) v:>,<,% ->2
# 2        <0> padav[@x 1612,1614] vM/LVINTRO ->3
# -        <;> ex-nextstate(main 1612 optree_misc.t:27) v:>,<,% ->3
# -        <1> rv2av[t4] vK/OURINTR,1 ->3
# -           <#> gv[*y] s ->-
# 3        <;> nextstate(main 1612 optree_misc.t:25) v:>,<,%,{ ->4
# 6        <2> add[t6] sK/2 ->7
# -           <1> ex-aelem sK/2 ->5
# 4              <0> aelemfast_lex[@x 1612,1614] sR/127 ->5
# -              <0> ex-const s ->-
# -           <1> ex-aelem sK/2 ->6
# -              <1> ex-rv2av sKR/1 ->-
...
# 7  <1> leavesub[1 ref] K/REFC,1 ->(end)
# -     <@> lineseq KP ->7
# 1        <;> nextstate(main 1612 optree_misc.t:27) v:>,<,% ->2
# 2        <0> padav[@x 1612,1614] vM/LVINTRO ->3
# -        <;> ex-nextstate(main 1612 optree_misc.t:27) v:>,<,% ->3
# -        <1> rv2av[t3] vK/OURINTR,1 ->3
# -           <$> gv(*y) s ->-
# 3        <;> nextstate(main 1612 optree_misc.t:27) v:>,<,%,{ ->4
# 6        <2> add[t4] sK/2 ->7
# -           <1> ex-aelem sK/2 ->5
# 4              <0> aelemfast_lex[@x 1612,1614] sR/127 ->5
# -              <0> ex-const s ->-
...
# -        <@> list vKP ->-
# 2           <0> padrange[$a 903,910; $b 903,910; $c 904,910; $d 1632,910; $e 1632,910; @f 906,910; $g 907,910; $h 908,910; $i 908,910; %j 909,910] vM/LVINTRO,10 ->3
...
# -        <;> nextstate(main 1632 optree_misc.t:371) v:>,<,%,{ ->-
# -        <@> list vKP ->-
# -           <0> pushmark vM/LVINTRO ->-
# -           <0> padsv[$d 1632,910] vM/LVINTRO ->-
# -           <0> padsv[$e 1632,910] vM/LVINTRO ->-
