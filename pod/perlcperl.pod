...
Later we will provide a special C<:const> hash table type to enable
optimizations to perfect hashes. With C<study %hash> you can do the
similar costly optimizations on non-const hashes at run-time to allow
faster key access.
...
L<http://perl11.github.io/blog/attributes-args.html>.
...
=head2 unicode folding tables as XS extension
...
=item L<http://perl11.github.io/cperl/>
