...
compile to bytecode properly again.
...
should not be implemented vi pure-perl (100x slower) and use esp. the
...
the recommended OO. Rather an optimizable perl6-like object system in
core.  Provide a simple MOP for reflection purposes, bot not for
...
some C<pp> runtime functions and herbey eliminations to function head,
parameter and return overhead.
