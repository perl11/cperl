...
perl5272cdelta - what is new for cperl v5.27.2
...
=item L<Scalar::Util> 2.49_09

fix find_rundefsvoffset logic
Fix t/subname.t for unstrict names
   perl5.26 started defining $Config{usecperl} as 'UNKNOWN', hence this check
   is now unreliable.

Merge with 1.49 upstream:
