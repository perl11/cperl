...
op and passes its arguments properly as in XS on the stack, not via C<@_>.
...
cperl honors the
L<TR31 Candidate Characters for Exclusion from Identifiers
...
With this restriction cperl fulfills the
...
Missing for more unicode security are warnings on single-, mixed and
whole-script confusables, with a new utf8 warnings 'confusables'
subcategory L<[cperl #265]|https://github.com/perl11/cperl/issues/265>.

With special declarations of the used scripts or turning off no warnings 'utf8',
you can weaken the restriction level to B<Minimally Restrictive>.
...
To fulfill the Moderately Restrictive Level for the Unicode
L<General Security Profile
|http://www.unicode.org/reports/tr39/#Restriction_Level_Detection>
you may not mix Greek with Cyrillic identifier characters in the same program.
...
See L</Internal Changes> and
L<[cperl #208]|https://github.com/perl11/cperl/issues/208>
...
See L<https://github.com/rurban/bignum/commits/cperl>
...
and contains approximately 420,000 lines of changes across 2,800 files from 75
authors.

Excluding auto-generated files, documentation and release tools, there were
approximately 260,000 lines of changes to 1,900 .pm, .t, .c and .h files.
