...
need to be declared.  The first non-default unicode script for an
identifier is the only allowed one. This qualifies as single-script.
More scripts lead to parsers errors.  See L<utf8/"Valid scripts">,
L<http://www.unicode.org/reports/tr36/#Mixed_Script_Spoofing> and
L<http://www.unicode.org/reports/tr31/>.

Please avoid the declaration of 'Cyrillic' and 'Greek' in one source file.
