...
The rationale to remove the handy C<for qw()> syntax was bogus and
annoying.  cperl 5.25.3 re-instated it for C<for> loops, but not for
the rest.  cperl does not insist on the backwards syntax to require
C<(qw( ... ))> around the C<for> list.
