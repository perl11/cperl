...
TODO: {
    ...
    # bug 20020208.005 [perl #8465] plus some single arg exec/system extras
...
{
    # ID 20020704.001 [perl #10026] taint propagation failure
    use re 'taint';
    $TAINT =~ /(.*)/;
    is_tainted(my $foo = $1);
}
