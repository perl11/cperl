...
The F<cperlivp> program is set up at Perl source code build time to test
...
=item L<cperlbug|cperlbug>

F<cperlbug> is the recommended way to report bugs in the cperl interpreter
itself or any of the standard library modules back to the developers;
please read through the documentation for F<cperlbug> thoroughly before
...
L<cperlbug|cperlbug>, L<h2ph|h2ph>, L<c2ph|c2ph>, L<h2xs|h2xs>, L<enc2xs>,
