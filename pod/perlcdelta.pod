...
Most static method calls on non-threaded perls are now optimized to
...
the subclasses yet to find the method.
...
Support for C<-DAFL_FUZZ> with L<afl-clang-fast|perlhacktips/"afl-fuzz">
