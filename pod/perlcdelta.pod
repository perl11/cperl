...
subroutine, optimize away the run-time method dispatch.
...
Also the slow GV lookup in entersub is converted to a faster CVref lookup.
...
methods and we don't change the ordering of the fields.  See L<[cperl
#311]|https://github.com/perl11/cperl/issues/311>
