...

{
    ...
    package Ẋẋ::ḐʙIＸ::Cl았::Ĭⁿᠠ텣올움ᶮ; use mro 'dfs';
    ...
    package Ẋẋ::ḐʙIＸ::Cl았::렐aチ온ሺṖ::Pr오xᠠMeᠠ옫ś; use mro 'dfs';
    our @ISA = qw/ Ẋẋ::ḐʙIＸ::Cl았 /;
    ...
    package Ẋẋ::ḐʙIＸ::Cl았::렐aチ온ሺṖ::ᛗᠠ톰ẰᚿẎ; our @ISA = (); use mro 'dfs';
    package Ẋẋ::ḐʙIＸ::Cl았::촘폰en팃엗; our @ISA = (); use mro 'dfs';
    package Ẋẋ::ḐʙIＸ::Cl았::ᚪc엤ȭઋᶢऋouᠠ; our @ISA = (); use mro 'dfs';
    package Ẋẋ::ḐʙIＸ::Cl았::ᠠᚱi알ḭźɜ::SX랍lえ; our @ISA = (); use mro 'dfs';
