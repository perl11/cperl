...
%Modules = (
    ...
    'Cpanel::JSON::XS' => {
        'DISTRIBUTION' => 'RURBAN/Cpanel-JSON-XS-3.0213.tar.gz',
    ...
    'IPC::SysV' => {
        'DISTRIBUTION' => 'MHX/IPC-SysV-2.06.tar.gz',
    ...
    'Math::BigInt' => {
        'DISTRIBUTION' => 'PJACKLAM/Math-BigInt-1.999716.tar.gz',
    ...
    'Socket' => {
        'DISTRIBUTION' => 'RURBAN/Socket-2.021_01.tar.gz',
        'FILES'        => q[cpan/Socket],
        'CUSTOMIZED'   => [
    ...
    'Time::HiRes' => {
        'DISTRIBUTION' => 'JHI/Time-HiRes-1.9732.tar.gz',
