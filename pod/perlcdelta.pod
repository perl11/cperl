...
with v5.30c.  Hash slices autovivified in subroutine arguments. This
was a bug, but to check all your code for correctness and portability
...
Fixed autovivifaction of hash slices in sub args.
