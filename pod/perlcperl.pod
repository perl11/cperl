...
fixing the algorithmic problem in the collision handling, not by
obscuring the users and fellow developers.  We properly analyzed many
hash functions and hash tables, for security and speed. The fastest,
FNV1a, was the one the fellow developer schmorp choose I<by his guts>
in his stableperl fork.
