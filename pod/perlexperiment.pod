...
These features were so wildly successful and played so well with
others that we decided to remove their experimental status and admit
them as full, stable features in the world of Perl, lavishing all the
benefits and luxuries thereof.  They are also awarded +5 Stability and
+3 Charisma.
...
Accepted in cperl 5.24.0, removed in Perl 5.24.0.

=item Subroutine signatures

Introduced in Perl 5.20.0

Accepted in cperl 5.24.0, still experimental in Perl.

See L<perlsub/Signatures>

=item The "const" attribute

Introduced in Perl 5.22.0 for subroutines only.

Accepted in cperl 5.24.0 for all data.

See L<perldata/Constant and typed lexical variables>
...
Moved from Perl 5.9.0 to CPAN, accepted in cperl 5.22.1
...
Removed in Perl 5.24.0, but kept and fixed in cperl 5.24.0
