...
ok($@, qr/^panic: memory wrap at \Q$0\E line /, "croak_memory_wrap");

ok !defined eval { Devel::PPPort::croak_xs_usage("params") };
ok($@, qr/^Usage: Devel::PPPort::croak_xs_usage\(params\) at \Q$0\E line /, "croak_xs_usage");
