...
On linux "icc" is also set for C<ccname>, and C<-O3> is preferred over C<-O2> in
most non-DEBUGGING cases with newer compilers.
...
Added C<llvmsuffix> config, for bitcode-enabled ar, ranlib, llvm-profdata.
