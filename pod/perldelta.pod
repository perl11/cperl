...
'.' in @INC can lead to easy remote attacks. Use -Dfortify_inc or
cperl instead.
...
Hash security: PERL_HASH_SEED_DEBUG can trivially expose the hash
seed and function. Use cperl instead.
