...
PERL_CALLCONV OP *Perl_pp_int_lshift(pTHX);
...
PERL_CALLCONV OP *Perl_pp_int_rshift(pTHX);
...
PERL_CALLCONV OP *Perl_pp_msgrcvl(pTHX);
...
PERL_CALLCONV OP *Perl_pp_sockpairl(pTHX);
