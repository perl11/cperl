...
arflags bin_ELF bootstrap_charset canned_gperf ccstdflags ccwarnflags
charsize cf_epoch config_argc config_args d_memrchr d_re_comp d_regcmp dlltool
dtraceobject dtracexnolibs git_ancestor git_commit_date
git_remote_branch git_unpushed hostgenerate hostosname hostperl incpth
installhtmldir installhtmlhelpdir ld_can_script libdb_needs_pthread
mad malloc_cflags passcat sysroot targetdir targetenv targethost
targetmkdir targetport useversionedarchname
...
ccflags_nolargefiles charbits config_heavy d_acosh d_asctime64 d_asinh
...
d_backtrace d_bcmp d_bcopy d_builtin_arith_overflow
d_builtin_choose_expr d_builtin_expect d_bzero d_c99_variadic_macros
d_cbrt d_charvspr d_clearenv d_copysign d_cplusplus d_ctermid
d_ctime64 d_dbl_dig d_difftime64 d_dir_dd_fd d_dladdr d_duplocale
d_erf d_erfc d_exp2 d_expm1 d_fdclose d_fdim d_fegetround d_fma d_fmax
...
d_inc_version_list d_index d_inetntop d_inetpton d_ip_mreq
d_ip_mreq_source d_ipv6_mreq d_ipv6_mreq_source d_isblank d_isfinitel
d_isinfl d_isless d_isnormal d_j0 d_j0l d_lc_monetary_2008 d_ldexpl
d_lgamma d_lgamma_r d_libname_unique d_llrint d_llrintl d_llround
d_llroundl d_localtime64 d_localtime_r_needs_tzset d_log1p d_log2
d_logb d_lrint d_lrintl d_lround d_lroundl d_malloc_good_size
d_malloc_size d_memchr d_memcmp d_memcpy d_memmem d_memmove d_memset
d_mktime64 d_modfl_pow32_bug d_modflproto d_nan d_ndbm
d_ndbm_h_uses_prototypes d_nearbyint d_newlocale d_nextafter
d_nexttoward d_nv_zero_is_allbits_zero d_prctl d_prctl_set_name
d_printf_format_null d_pseudofork d_ptrdiff_t d_regcomp d_remainder
d_remquo d_rint d_round d_safebcpy d_safemcpy d_sanemcmp d_scalbn
...
d_strlcpy d_strchr d_strctcpy d_tgamma d_timegm d_trunc d_truncl
d_unsetenv d_uselocale d_ustat d_vendorscript
d_vms_case_sensitive_symbols d_volatile d_vprintf d_vsnprintf d_wcscmp
d_wcsxfrm defvoidused dl_so_eq_ext doop_cflags doubleinfbytes
doublekind doublemantbits doublenanbytes dtrace extern_C found_libucb
from gccansipedantic git_branch git_commit_id git_commit_id_title
git_describe git_uncommitted_changes gnulibc_version hash_func
html1dir html1direxp html3dir html3direxp i_assert i_bfd i_dld
i_execinfo i_fenv i_float i_gdbm_ndbm i_gdbmndbm i_limits
i_mallocmalloc i_mntent i_quadmath i_sfio i_stdarg i_stdbool i_stddef
i_stdint i_stdlib i_sysmount i_syspoll i_sysstatfs i_sysstatvfs
i_sysvfs i_ustat i_xlocale i_varargs i_varhdr ieeefp_h
initialinstalllocation installhtml1dir installhtml3dir
installsitehtml1dir installsitehtml3dir installsiteman1dir
...
pthread_h_first prototype regexec_cflags rm_try run sGMTIME_max
...
siteman3direxp sitescript sitescriptexp st_ino_sign st_ino_size
targetsh to toke_cflags usecbacktrace usecperl usedevel usedtrace
usekernprocpathname usensgetexecutablepath usequadmath
userelocatableinc usesfio vaproto vendorhtml1dir vendorhtml1direxp
vendorhtml3dir vendorhtml3direxp vendorman1dir vendorman1direxp
vendorman3dir vendorman3direxp vendorscript vendorscriptexp voidflags
yacc yaccflags
