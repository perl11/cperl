...
PERL_CALLCONV OP *Perl_pp_aelem_u(pTHX);
PERL_CALLCONV OP *Perl_pp_aelemfast(pTHX);
PERL_CALLCONV OP *Perl_pp_aelemfast_lex_u(pTHX);
...
PERL_CALLCONV OP *Perl_pp_box_int(pTHX);
PERL_CALLCONV OP *Perl_pp_box_num(pTHX);
PERL_CALLCONV OP *Perl_pp_box_str(pTHX);
PERL_CALLCONV OP *Perl_pp_box_uint(pTHX);
...
PERL_CALLCONV OP *Perl_pp_cmp(pTHX);
...
PERL_CALLCONV OP *Perl_pp_enterffi(pTHX);
...
PERL_CALLCONV OP *Perl_pp_i_aelem(pTHX);
PERL_CALLCONV OP *Perl_pp_i_bit_and(pTHX);
PERL_CALLCONV OP *Perl_pp_i_bit_or(pTHX);
PERL_CALLCONV OP *Perl_pp_i_cmp(pTHX);
PERL_CALLCONV OP *Perl_pp_i_complement(pTHX);
...
PERL_CALLCONV OP *Perl_pp_i_pow(pTHX);
PERL_CALLCONV OP *Perl_pp_i_subtract(pTHX);
PERL_CALLCONV OP *Perl_pp_index(pTHX);
PERL_CALLCONV OP *Perl_pp_int(pTHX);
PERL_CALLCONV OP *Perl_pp_int_abs(pTHX);
PERL_CALLCONV OP *Perl_pp_int_add(pTHX);
PERL_CALLCONV OP *Perl_pp_int_aelem(pTHX);
PERL_CALLCONV OP *Perl_pp_int_aelem_u(pTHX);
PERL_CALLCONV OP *Perl_pp_int_divide(pTHX);
PERL_CALLCONV OP *Perl_pp_int_eq(pTHX);
PERL_CALLCONV OP *Perl_pp_int_ge(pTHX);
PERL_CALLCONV OP *Perl_pp_int_gt(pTHX);
PERL_CALLCONV OP *Perl_pp_int_le(pTHX);
PERL_CALLCONV OP *Perl_pp_int_lt(pTHX);
PERL_CALLCONV OP *Perl_pp_int_modulo(pTHX);
PERL_CALLCONV OP *Perl_pp_int_multiply(pTHX);
PERL_CALLCONV OP *Perl_pp_int_ne(pTHX);
...
PERL_CALLCONV OP *Perl_pp_int_subtract(pTHX);
PERL_CALLCONV OP *Perl_pp_introcv(pTHX);
PERL_CALLCONV OP *Perl_pp_ioctl(pTHX);
PERL_CALLCONV OP *Perl_pp_iter(pTHX);
PERL_CALLCONV OP *Perl_pp_iter_ary(pTHX);
PERL_CALLCONV OP *Perl_pp_iter_lazyiv(pTHX);
PERL_CALLCONV OP *Perl_pp_join(pTHX);
PERL_CALLCONV OP *Perl_pp_keepstate(pTHX);
...
PERL_CALLCONV OP *Perl_pp_num_add(pTHX);
PERL_CALLCONV OP *Perl_pp_num_atan2(pTHX);
PERL_CALLCONV OP *Perl_pp_num_cos(pTHX);
PERL_CALLCONV OP *Perl_pp_num_divide(pTHX);
PERL_CALLCONV OP *Perl_pp_num_exp(pTHX);
PERL_CALLCONV OP *Perl_pp_num_log(pTHX);
PERL_CALLCONV OP *Perl_pp_num_multiply(pTHX);
PERL_CALLCONV OP *Perl_pp_num_pow(pTHX);
PERL_CALLCONV OP *Perl_pp_num_sin(pTHX);
PERL_CALLCONV OP *Perl_pp_num_sqrt(pTHX);
PERL_CALLCONV OP *Perl_pp_num_subtract(pTHX);
PERL_CALLCONV OP *Perl_pp_oct(pTHX);
PERL_CALLCONV OP *Perl_pp_oelem(pTHX);
PERL_CALLCONV OP *Perl_pp_oelemfast(pTHX);
...
PERL_CALLCONV OP *Perl_pp_s_bit_and(pTHX);
PERL_CALLCONV OP *Perl_pp_s_bit_or(pTHX);
PERL_CALLCONV OP *Perl_pp_s_cmp(pTHX);
PERL_CALLCONV OP *Perl_pp_s_complement(pTHX);
PERL_CALLCONV OP *Perl_pp_s_eq(pTHX);
PERL_CALLCONV OP *Perl_pp_s_le(pTHX);
PERL_CALLCONV OP *Perl_pp_s_ne(pTHX);
...
PERL_CALLCONV OP *Perl_pp_setstate(pTHX);
...
PERL_CALLCONV OP *Perl_pp_uint_complement(pTHX);
PERL_CALLCONV OP *Perl_pp_uint_left_shift(pTHX);
PERL_CALLCONV OP *Perl_pp_uint_pow(pTHX);
PERL_CALLCONV OP *Perl_pp_uint_right_shift(pTHX);
PERL_CALLCONV OP *Perl_pp_umask(pTHX);
PERL_CALLCONV OP *Perl_pp_unbox_int(pTHX);
PERL_CALLCONV OP *Perl_pp_unbox_num(pTHX);
PERL_CALLCONV OP *Perl_pp_unbox_str(pTHX);
PERL_CALLCONV OP *Perl_pp_unbox_uint(pTHX);
