...
files are F<git_version.h>, F<git_version.sh> and F<lib/Config_git.pl>.
...
format, designed to be used by F<patchlevel.h>. This file is
later on replaced by the version created by this script.

C<git_version.sh> contains similar information in a shell file
format, designed to be used by F<myconfig.SH>.

=head1 AUTHOR

Yves Orton, Kenichi Ishigaki, Max Maischein, Reini Urban
...
write_files(<<"EOF_HEADER", <<"EOF_CONFIG", <<"EOF_SHELL");
/**************************************************************************
...
EOF_CONFIG
######################################################################
# WARNING: 'git_version.sh' is generated by make_patchnum.pl
#          DO NOT EDIT DIRECTLY - edit make_patchnum.pl instead
######################################################################
git_commit_id='$commit_id'
git_describe='$describe'
