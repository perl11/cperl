...
%Modules = (
    ...
    'B::C' => {
        'DISTRIBUTION' => 'RURBAN/B-C-1.57.tar.gz',
        'FILES'        => q[cpan/B-C],
        'EXCLUDED'     => [
            qr{^.gdb},
            qr{^t/z_pod\.t/},
    ...
    'bignum' => {
        ...
        # modernized cperl variant 0.51c
    ...
    'CPAN' => {
        'DISTRIBUTION' => 'ANDK/CPAN-2.27-TRIAL.tar.gz',
        'FILES'        => q[cpan/CPAN],
        'EXCLUDED'     => [
            qr{^inc/Test/},
            qr{^t/97-},
    ...
    'Devel::PPPort' => {
        'DISTRIBUTION' => 'RURBAN/Devel-PPPort-3.53_04.tar.gz',
    ...
    'File::Temp' => {
        'DISTRIBUTION' => 'DAGOLDEN/File-Temp-0.2309.tar.gz',
    ...
    'IO' => {
        'DISTRIBUTION' => 'TODDR/IO-1.40.tar.gz',
        'FILES'        => q[dist/IO/],
        'EXCLUDED'     => ['t/test.pl'],
    ...
    'File::Spec' => {
        'DISTRIBUTION' => 'XSAWYERX/PathTools-3.78.tar.gz',
    ...
    'Socket' => {
        'DISTRIBUTION' => 'RURBAN/Socket-2.029_05.tar.gz',
        'FILES'        => q[cpan/Socket],
    },

    'Storable' => {
        'DISTRIBUTION' => 'RURBAN/Storable-3.15_04.tar.gz',
    ...
    'Term::ReadKey' => {
        'DISTRIBUTION' => 'JSTOWE/TermReadKey-2.38.tar.gz',
    ...
    'threads::shared' => {
        'DISTRIBUTION' => 'JDHEDDEN/threads-shared-1.60.tar.gz',
    ...
    'YAML::Safe' => {
        'DISTRIBUTION' => "RURBAN/YAML-Safe-0.80.tar.gz",
        'FILES'        => q[cpan/YAML-Safe],
    },
