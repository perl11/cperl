...
PL_op_type[] = {
	...
	0x0606ff0b,	/* 65: u_add "(:Int,:Int):Numeric" */
	0x0b0bff0b,	/* 66: subtract "(:Numeric,:Numeric):Numeric" */
	0x0606ff06,	/* 67: i_subtract "(:Int,:Int):Int" */
	0x1212ff09,	/* 68: concat "(:Any,:Any):Str" */
	0x0cffff09,	/* 69: stringify "(:Scalar):Str" */
	0x0607ff07,	/* 70: left_shift "(:Int,:UInt):UInt" */
	0x0607ff07,	/* 71: right_shift "(:Int,:UInt):UInt" */
	0x0c0cff0a,	/* 72: lt "(:Scalar,:Scalar):Bool" */
	0x0606ff0a,	/* 73: i_lt "(:Int,:Int):Bool" */
	0x0c0cff0a,	/* 74: gt "(:Scalar,:Scalar):Bool" */
	0x0606ff0a,	/* 75: i_gt "(:Int,:Int):Bool" */
	0x0c0cff0a,	/* 76: le "(:Scalar,:Scalar):Bool" */
	0x0606ff0a,	/* 77: i_le "(:Int,:Int):Bool" */
	0x0c0cff0a,	/* 78: ge "(:Scalar,:Scalar):Bool" */
	0x0606ff0a,	/* 79: i_ge "(:Int,:Int):Bool" */
	0x0c0cff0a,	/* 80: eq "(:Scalar,:Scalar):Bool" */
	0x0606ff0a,	/* 81: i_eq "(:Int,:Int):Bool" */
	0x0c0cff0a,	/* 82: ne "(:Scalar,:Scalar):Bool" */
	0x0606ff0a,	/* 83: i_ne "(:Int,:Int):Bool" */
	0x0c0cff06,	/* 84: cmp "(:Scalar,:Scalar):Int" */
	0x0606ff06,	/* 85: i_cmp "(:Int,:Int):Int" */
	0x0909ff0a,	/* 86: s_lt "(:Str,:Str):Bool" */
	0x0909ff0a,	/* 87: s_gt "(:Str,:Str):Bool" */
	0x0909ff0a,	/* 88: s_le "(:Str,:Str):Bool" */
	0x0909ff0a,	/* 89: s_ge "(:Str,:Str):Bool" */
	0x0909ff0a,	/* 90: s_eq "(:Str,:Str):Bool" */
	0x0909ff0a,	/* 91: s_ne "(:Str,:Str):Bool" */
	0x0909ff06,	/* 92: s_cmp "(:Str,:Str):Int" */
	0x0b0bff07,	/* 93: bit_and "(:Numeric,:Numeric):UInt" */
	0x0b0bff07,	/* 94: bit_xor "(:Numeric,:Numeric):UInt" */
	0x0b0bff07,	/* 95: bit_or "(:Numeric,:Numeric):UInt" */
	0x0606ff07,	/* 96: i_bit_and "(:Int,:Int):UInt" */
	0x0606ff07,	/* 97: i_bit_xor "(:Int,:Int):UInt" */
	0x0606ff07,	/* 98: i_bit_or "(:Int,:Int):UInt" */
	0x0909ff09,	/* 99: s_bit_and "(:Str,:Str):Str" */
	0x0909ff09,	/* 100: s_bit_xor "(:Str,:Str):Str" */
	0x0909ff09,	/* 101: s_bit_or "(:Str,:Str):Str" */
	0x0bffff0b,	/* 102: negate "(:Numeric):Numeric" */
	0x06ffff06,	/* 103: i_negate "(:Int):Int" */
	0x0cffff0a,	/* 104: not "(:Scalar):Bool" */
	0x0cffff0c,	/* 105: complement "(:Scalar):Scalar" */
	0x07ffff07,	/* 106: i_complement "(:UInt):UInt" */
	0x09ffff09,	/* 107: s_complement "(:Str):Str" */
	0xffffffff,	/* 108: smartmatch "" */
	0x0808ff08,	/* 109: atan2 "(:Num,:Num):Num" */
	0x08ffff08,	/* 110: sin "(:Num):Num" */
	0x08ffff08,	/* 111: cos "(:Num):Num" */
	0xe8ffff08,	/* 112: rand "(:Num?):Num" */
	0xe8ffff08,	/* 113: srand "(:Num?):Num" */
	0x08ffff08,	/* 114: exp "(:Num):Num" */
	0x08ffff08,	/* 115: log "(:Num):Num" */
	0x08ffff08,	/* 116: sqrt "(:Num):Num" */
	0x0bffff0b,	/* 117: int "(:Numeric):Numeric" */
	0x0bffff07,	/* 118: hex "(:Numeric):UInt" */
	0x0bffff07,	/* 119: oct "(:Numeric):UInt" */
	0x0bffff0b,	/* 120: abs "(:Numeric):Numeric" */
	0x02ffff06,	/* 121: box_int "(:int):Int" */
	0x03ffff07,	/* 122: box_uint "(:uint):UInt" */
	0x05ffff09,	/* 123: box_str "(:str):Str" */
	0x04ffff08,	/* 124: box_num "(:num):Num" */
	0x06ffff02,	/* 125: unbox_int "(:Int):int" */
	0x06ffff03,	/* 126: unbox_uint "(:Int):uint" */
	0x09ffff05,	/* 127: unbox_str "(:Str):str" */
	0x08ffff04,	/* 128: unbox_num "(:Num):num" */
	0x0302ff03,	/* 129: uint_left_shift "(:uint,:int):uint" */
	0x0302ff03,	/* 130: uint_right_shift "(:uint,:int):uint" */
	0x0302ff03,	/* 131: uint_pow "(:uint,:int):uint" */
	0x03ffff03,	/* 132: uint_complement "(:uint):uint" */
	0x02ffff02,	/* 133: int_preinc "(:int):int" */
	0x02ffff02,	/* 134: int_predec "(:int):int" */
	0x02ffff02,	/* 135: int_postinc "(:int):int" */
	0x02ffff02,	/* 136: int_postdec "(:int):int" */
	0x0202ff02,	/* 137: int_add "(:int,:int):int" */
	0x0202ff02,	/* 138: int_subtract "(:int,:int):int" */
	0x0202ff02,	/* 139: int_multiply "(:int,:int):int" */
	0x0202ff02,	/* 140: int_divide "(:int,:int):int" */
	0x0202ff02,	/* 141: int_modulo "(:int,:int):int" */
	0x02ffff02,	/* 142: int_negate "(:int):int" */
	0x02ffff02,	/* 143: int_not "(:int):int" */
	0x02ffff02,	/* 144: int_abs "(:int):int" */
	0x0202ff02,	/* 145: int_lt "(:int,:int):int" */
	0x0202ff02,	/* 146: int_gt "(:int,:int):int" */
	0x0202ff02,	/* 147: int_le "(:int,:int):int" */
	0x0202ff02,	/* 148: int_ge "(:int,:int):int" */
	0x0202ff02,	/* 149: int_eq "(:int,:int):int" */
	0x0202ff02,	/* 150: int_ne "(:int,:int):int" */
	0x0404ff04,	/* 151: num_add "(:num,:num):num" */
	0x0404ff04,	/* 152: num_subtract "(:num,:num):num" */
	0x0404ff04,	/* 153: num_multiply "(:num,:num):num" */
	0x0404ff04,	/* 154: num_divide "(:num,:num):num" */
	0x0404ff04,	/* 155: num_atan2 "(:num,:num):num" */
	0x0404ff04,	/* 156: num_pow "(:num,:num):num" */
	0x04ffff04,	/* 157: num_sin "(:num):num" */
	0x04ffff04,	/* 158: num_cos "(:num):num" */
	0x04ffff04,	/* 159: num_exp "(:num):num" */
	0x04ffff04,	/* 160: num_log "(:num):num" */
	0x04ffff04,	/* 161: num_sqrt "(:num):num" */
	...
	0x0dffff10,	/* 177: rv2av "(:Ref):Hash" */
	0xffffff0c,	/* 178: aelemfast "():Scalar" */
	0xffffff0c,	/* 179: aelemfast_lex "():Scalar" */
	0x2c06ff0c,	/* 180: aelem "(:Array(:Scalar),:Int):Scalar" */
	0x2606ff06,	/* 181: i_aelem "(:Array(:Int),:Int):Int" */
	0x2806ff08,	/* 182: n_aelem "(:Array(:Num),:Int):Num" */
	0x2906ff09,	/* 183: s_aelem "(:Array(:Str),:Int):Str" */
	0x2202ff02,	/* 184: int_aelem "(:Array(:int),:int):int" */
	0x2402ff04,	/* 185: num_aelem "(:Array(:num),:int):num" */
	0x2502ff05,	/* 186: str_aelem "(:Array(:str),:int):str" */
	...
	0xffffffff,	/* 194: keys "" */
	0x09ffff01,	/* 195: delete "(:Str):Void" */
	0x09ffff0a,	/* 196: exists "(:Str):Bool" */
	0x0dffff10,	/* 197: rv2hv "(:Ref):Hash" */
	0xccffff0c,	/* 198: helem "(:Hash(:Scalar)):Scalar" */
	...
	0xffffffff,	/* 222: flip "" */
	0xffffffff,	/* 223: flop "" */
	0x0c0cff01,	/* 224: and "(:Scalar,:Scalar):Void" */
	0xffffffff,	/* 225: or "" */
	0xffffffff,	/* 226: xor "" */
	0xffffffff,	/* 227: dor "" */
	0x0cffff01,	/* 228: cond_expr "(:Scalar):Void" */
	...
	0xffffff01,	/* 241: lineseq "():Void" */
	0xffffff01,	/* 242: nextstate "():Void" */
	0xffffff01,	/* 243: dbstate "():Void" */
	0xffffff01,	/* 244: unstack "():Void" */
	0xffffffff,	/* 245: enter "" */
	0xffffffff,	/* 246: leave "" */
	0xffffff01,	/* 247: scope "():Void" */
