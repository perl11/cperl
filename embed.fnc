...
AaTop	|Malloc_t|realloc	|Malloc_t where|MEM_SIZE nbytes
...
Apx	|void	|apply_attrs_string	|NN const char *stashpv|NN CV *cv \
					|NN const char *attrstr|STRLEN len
#if defined(USE_CPERL)
: Used in perly.y Might be replaced with attrs_runtime
pxdRP	|int	|attrs_has_const|NULLOK OP* o|bool from_assign
#endif
...
#if defined(USE_CPERL)
Apdex	|AV*	|av_init_shaped	|NN AV *av|const SSize_t size|NULLOK const HV *type
#endif
...
ATprd	|void	|croak_no_modify|NN const char* file|int line
#if defined(USE_CPERL)
Aprd	|void	|croak_no_modify_sv|NN SV* sv|NN const char* file|int line
Tpr	|void	|croak_shaped_array|NN const char *opname
#endif
...
iT	|bool	|potential_mod_type	|I32 type
...
#  if defined(USE_CPERL)
SRx	|void *	|hv_common_magical	|NN HV *hv|NULLOK SV **keyp \
...
ATdmoR	|bool	|is_utf8_invariant_string|NN const U8* const s|STRLEN len
...
ATidR	|bool	|is_utf8_string_flags	|NN const U8 *s|STRLEN len|const U32 flags
...
AxpR	|bool	|_is_utf8_FOO_with_len	|const U8 classnum|NN const U8 * const p \
		|NN const U8 * const e
...
#if defined(USE_CPERL)
: FIXME already removed from perl5
AxpR	|bool	|_is_utf8_perl_idcont	|NN const U8 *p
AxpR	|bool	|_is_utf8_perl_idstart	|NN const U8 *p
#endif
...
#if defined(USE_CPERL)
AxpR	|bool	|_is_decomposed_string	|NN const U8 *p|STRLEN len
#endif
#if defined(PERL_CORE) || defined(PERL_EXT)
...
#endif
#if defined(USE_CPERL)
Axp	|bool	|valid_ident		|NN SV* sv|bool strict_names \
...
pT	|PADOFFSET|fields_padoffset|NN const char *fields|const int offset|const char padsize
Apd	|U16	|numfields	|NN const HV* klass
ApTd	|int	|fields_size	|NULLOK char* fields
...
iT	|int	|match_type1	|const U32 sig|core_types_t arg1
iT	|int	|match_type2	|const U32 sig|core_types_t arg1|core_types_t arg2
i	|OP*	|new_entersubop |NN GV* gv |NN OP* arg
#    ifdef PERL_INLINE_SUBS
Sx	|bool	|cv_check_inline|NN const OP *o|NN CV *compcv
Sx	|OP*	|cv_do_inline   |NULLOK OP *parent|NN OP *o|NN OP *cvop|NN CV *cv
Sx	|OP*	|op_clone_sv	|NN OP* o
#    endif
#  endif
#endif
...
AxRp	|OP*	|op_clone_optree|NN OP* o  |bool init
#endif
...
ioR	|NV	|strtod		|NN const char * const s|NULLOK char ** e
#endif
...
#if defined(USE_CPERL)
AxpdRT	|PADNAME *|newPADNAMEpvn_flags|NN const char *s|STRLEN len|U32 flags
#endif
...
Axpd	|void	|wrap_keyword_plugin|NN Perl_keyword_plugin_t new_plugin \
...
#if defined(USE_CPERL)
Axp	|void	|class_role	|NN OP* o
Axp	|void	|class_role_finalize|NN OP* o
#  if defined(PERL_IN_OP_C)
...
: "Very" special - can not use the O flag for this one:
...
p	|OP*	|pmruntime	|NN OP *o|NN OP *expr|NULLOK OP *repl \
				|UV flags|I32 floor
#if defined(USE_CPERL)
px	|OP *	|attrs_runtime	|NN CV *cv|NN OP *attrs
#endif
#if defined(PERL_IN_OP_C)
...
#if defined(USE_CPERL)
ATp	|void	|repeatcpy	|NN char* to|NN const char* from|I32 len|UV count
#else
: a perl5 limitation
...
ATp	|Signal_t |csighandler	|int sig|UNUSED NULLOK siginfo_t *info|UNUSED NULLOK void *uap
#else
...
EXpRx	|SV*	|swash_init	|NN const char* pkg|NN const char* name|NN SV* listsv \
...
ESxR	|SV*	|_make_exactf_invlist	|NN RExC_state_t *pRExC_state \
					|NN regnode *node
...
EXmx	|void	|_invlist_intersection	|NN SV* const a|NN SV* const b \
					|NN SV** i
...
EXxp	|void	|utf8_check_script|NN const U8 *s
#  endif
#  if defined(PERL_IN_TOKE_C)
iR	|int	|isFATARROW	|NN const char *s
iR	|int	|isRIGHTARROW	|NN const char *s
iRT	|U8 	|UNIsuperscript	|NN const char *t
#  endif
#endif
Ap	|void	|taint_env
...
ixR	|char *	|unexpected_non_continuation_text			\
		|NN const U8 * const s					\
		|STRLEN print_len					\
...
#else
: a perl5 limitation, A needed for the compiler
...
#if defined(USE_CPERL)
: a perl5 security risk
AxpdR	|char*	|pv_uni_normalize|NN char *s1|STRLEN len|NULLOK STRLEN *dlenp
#endif
...
XExp	|void	|deb_hek	|NULLOK HEK* hek|NULLOK SV* val
XExp	|void	|deb_hechain	|NULLOK HE* entry
...
#if defined(USE_CPERL)
: a perl5 limitation, needed for the compiler
...
i	|bool|parse_gv_stash_name|NN HV **stash|NN GV **gv \
                     |NN const char **name|NN STRLEN *len \
                     |NN const char *nambeg|STRLEN full_len \
                     |const U32 is_utf8|const I32 add
i	|bool|find_default_stash|NN HV **stash|NN const char *name \
                     |STRLEN len|const U32 is_utf8|const I32 add \
                     |const svtype sv_type
i	|bool|gv_magicalize|NN GV *gv|NN HV *stash|NN const char *name \
                     |STRLEN len \
                     |const svtype sv_type
i	|void|maybe_multimagic_gv|NN GV *gv|NN const char *name|const svtype sv_type
i	|bool|gv_is_in_main|NN const char *name|STRLEN len \
                      |const U32 is_utf8
#  if defined(USE_CPERL)
...
S	|void	|clear_special_blocks	|NN const char *const fullname\
					|NN GV *const gv|NN CV *const cv
ST	|void	|prune_chain_head 	|NN OP** op_p
#  if defined(USE_CPERL)
S	|const char*|typename 	|NULLOK const HV* stash
iT	|OP*	|op_next_nn 	|NN OP* o
iT	|OP*	|op_prev_nn 	|NN const OP* us
iT	|OP*	|op_prevstart_nn|NN const OP* start|NN const OP* us
...
Sx	|void	|process_optree	|NULLOK CV *cv|NN OP *root|NN OP *start
...
#    endif
Sx	|void	|maybe_multiconcat	|NN OP *o
S	|bool	|aassign_padcheck|NN OP* o|bool rhs
S	|int	|aassign_scan	|NN OP* o|bool rhs|bool top|NN int *scalars_p
ST	|void	|check_for_bool_cxt |NN OP* o|bool safe_and|U8 bool_flag|U8 maybe_flag
...
S	|void	|maybe_multideref|NN OP *start|NN OP *orig_o|UV orig_action\
				 |U8 hints
...
Sx	|OP*	|op_fixup	 |NULLOK OP *old|NULLOK OP *newop|U32 init
#  endif /*CPERL */
#endif /* OP_C */
...
i	|void	|do_concat	|NN SV *left|NN SV *right|NN SV *targ|U8 targmy
i	|OP*	|padhv_rv2hv_common	|NN HV *hv|U8 gimme|bool is_keys|bool has_targ
#  ifdef DEBUGGING
i	|void	|aassign_copy_common	|NN SV **firstlelem|NN SV **lastlelem \
					|NN SV **firstrelem|NN SV **lastrelem \
					|bool fake
#  else
i	|void	|aassign_copy_common	|NN SV **firstlelem|NN SV **lastlelem \
					|NN SV **firstrelem|NN SV **lastrelem
...
So	|OP*	|ft_return_false|NN SV *ret
io	|OP*	|ft_return_true	|NN SV *ret
...
ES	|bool	|regtail_study	|NN RExC_state_t *pRExC_state \
				|regnode_offset p|const regnode_offset val|U32 depth
#else
: a perl5 api bug
ES	|bool	|regtail_study	|NN RExC_state_t *pRExC_state \
...
ERiTo	|SSize_t|get_break_val_cp_checked|NN SV* const invlist|const UV cp_in
...
#if defined(PERL_IN_SV_C)
TiR	|char *	|uiv_2buf	|NN char *const buf|const IV iv|UV uv|const int is_uv \
				|NN char **const peob
i	|void	|sv_unglob	|NN SV *const sv|U32 flags
io	|void	|sv_catpvn_simple|NN SV *const sv|NN const char* const buf|const STRLEN len
...
EXxpR	|HV *	|find_in_coretypes|NN const char *pkgname|STRLEN len
#endif
...
#endif
#if defined(USE_CPERL)
EXxp	|bool	|validate_proto	|NN SV *name|NULLOK SV *proto|bool dowarn \
...
S	|bool	|isa_lookup	|NN HV *stash|NN const char * const name \
                                        |STRLEN len|U32 flags
#  if defined(USE_CPERL)
iT	|PADOFFSET|fields_po	|NN SV *obj
iT	|U16	  |fields_ix	|NN SV *obj
iT	|HV*	  |fields_class	|NN SV *obj
iT	|SV*	  |fields_obj	|NN SV *obj
iT	|SV*	  |fields_objcheck	|NULLOK SV *obj
#  endif
#endif
...
#if defined(PERL_IN_UTIL_C)
ioR	|bool	|gv_has_usable_name	|NN GV *gv
S	|SV*	|mess_alloc
...
pT	|Malloc_t	|mem_log_alloc	|const UV nconst|UV typesize \
					|NN const char *type_name|Malloc_t newalloc \
                                        |NN const char *filename|const int linenumber \
                                        |NN const char *funcname
pT	|Malloc_t	|mem_log_realloc |const UV n|const UV typesize \
...
pT	|Malloc_t	|mem_log_free	|Malloc_t oldalloc|NN const char *filename \
					|const int linenumber|NN const char *funcname
#endif
...
ATRd	|FILE *|PerlIO_exportFILE	|NN PerlIO *f|NULLOK const char* mode
ATRd	|FILE *|PerlIO_findFILE		|NN PerlIO *f
ATd	|void  |PerlIO_releaseFILE	|NN PerlIO *p|NN FILE *f
: used in perlio.c and the compiler
Axo	|void|PerlIO_cleanup
Axo	|void|PerlIO_destruct
#endif
#endif /* USE_PERLIO */

: Only used in dump.c
p	|void	|deb_stack_all
: in perl5 exported without DEBUGGING:
...
#if defined(USE_CPERL)
Apd	|PADOFFSET|pad_findmy_realoffset|PADOFFSET po|NN CV* cv
...
#if defined(PERL_IN_PAD_C)
#  if defined(USE_CPERL)
id	|PADOFFSET|pad_find_outeroffset |NN PADNAME *pn|NN CV* cv
#  endif
...
xp	|PADNAMELIST *|cv_clone_padname0|NN CV *cv|NN PADNAMELIST *pnl
#endif
#if defined(PERL_IN_OP_C) || defined(PERL_IN_TOKE_C) || defined(PERL_IN_XSUTILS_C)
xp	|void	|cv_type_set|NN CV *cv|NN HV *stash
#endif
...
ApdRxD	|SV*	|hv_bucket_ratio|NN HV *hv
...
#endif
#if defined(USE_CPERL)
ApoT	|I32	|xs_handshake	|const U32 key|NN void * v_my_perl\
				|NN const char * file| ...
#else
...
: in perl5 the next 6 fncs with 'o'
...
#if defined(USE_CPERL)
ExpPX	|SV*	|_get_encoding
#endif
Ap	|void	|clear_defarray	|NN AV* av|bool abandon
Axp	|void	|leave_adjust_stacks	|NN SV **from_sp |NN SV **to_sp \
					|U8 gimme |int filter

#if defined(USE_CPERL)
: Used in xsutils.c, dlboot.c and xs-only extensions
Axp	|void	|set_version   |NN const char *name  |STRLEN nlen \
                               |NN const char *strval|STRLEN plen \
                               |NV nvval
#  if defined(PERL_IN_PP_TYPE_C)
#    ifdef PERL_NATIVE_TYPES
iTo	|UV	|upow		|UV base|IV exp
#    endif
#  endif
#endif
...
Sx      |const char *	|action_name	|const int action
#endif
