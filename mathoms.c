...
PERL_MATHOM_CALLCONV OP * Perl_ref(pTHX_ OP *o, I32 type);
PERL_MATHOM_CALLCONV void Perl_sv_unref(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV void Perl_sv_taint(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV IV Perl_sv_2iv(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV UV Perl_sv_2uv(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV NV Perl_sv_2nv(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV char * Perl_sv_2pv(pTHX_ SV *sv, STRLEN *lp);
PERL_MATHOM_CALLCONV char * Perl_sv_2pv_nolen(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV char * Perl_sv_2pvbyte_nolen(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV char * Perl_sv_2pvutf8_nolen(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV void Perl_sv_force_normal(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV void Perl_sv_setsv(pTHX_ SV *dstr, SV *sstr);
PERL_MATHOM_CALLCONV void Perl_sv_catpvn(pTHX_ SV *dsv, const char* sstr, STRLEN slen);
PERL_MATHOM_CALLCONV void Perl_sv_catpvn_mg(pTHX_ SV *sv, const char *ptr, STRLEN len);
PERL_MATHOM_CALLCONV void Perl_sv_catsv(pTHX_ SV *dstr, SV *sstr);
PERL_MATHOM_CALLCONV void Perl_sv_catsv_mg(pTHX_ SV *dsv, SV *ssv);
PERL_MATHOM_CALLCONV char * Perl_sv_pv(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV char * Perl_sv_pvn_force(pTHX_ SV *sv, STRLEN *lp);
PERL_MATHOM_CALLCONV char * Perl_sv_pvbyte(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV char * Perl_sv_pvutf8(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV STRLEN Perl_sv_utf8_upgrade(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV NV Perl_huge(void);
PERL_MATHOM_CALLCONV void Perl_gv_fullname3(pTHX_ SV *sv, const GV *gv, const char *prefix);
PERL_MATHOM_CALLCONV void Perl_gv_efullname3(pTHX_ SV *sv, const GV *gv, const char *prefix);
PERL_MATHOM_CALLCONV GV * Perl_gv_fetchmethod(pTHX_ HV *stash, const char *name);
PERL_MATHOM_CALLCONV HE * Perl_hv_iternext(pTHX_ HV *hv);
PERL_MATHOM_CALLCONV void Perl_hv_magic(pTHX_ HV *hv, GV *gv, int how);
PERL_MATHOM_CALLCONV bool Perl_do_open(pTHX_ GV *gv, const char *name, I32 len, int as_raw, int rawmode, int rawperm, PerlIO *supplied_fp);
PERL_MATHOM_CALLCONV bool Perl_do_aexec(pTHX_ SV *really, SV **mark, SV **sp);
PERL_MATHOM_CALLCONV U8 * Perl_uvuni_to_utf8(pTHX_ U8 *d, UV uv);
PERL_MATHOM_CALLCONV bool Perl_is_utf8_string_loc(pTHX_ const U8 *s, STRLEN len, const U8 **ep);
PERL_MATHOM_CALLCONV void Perl_sv_nolocking(pTHX_ SV *sv);
PERL_MATHOM_CALLCONV void Perl_sv_usepvn_mg(pTHX_ SV *sv, char *ptr, STRLEN len);
PERL_MATHOM_CALLCONV void Perl_sv_usepvn(pTHX_ SV *sv, char *ptr, STRLEN len);
PERL_CALLCONV int Perl_fprintf_nocontext(PerlIO *stream, const char *format, ...);
PERL_CALLCONV int Perl_printf_nocontext(const char *format, ...);
PERL_MATHOM_CALLCONV int Perl_magic_setglob(pTHX_ SV* sv, MAGIC* mg);
PERL_MATHOM_CALLCONV AV * Perl_newAV(pTHX);
PERL_MATHOM_CALLCONV HV * Perl_newHV(pTHX);
PERL_MATHOM_CALLCONV IO * Perl_newIO(pTHX);
PERL_MATHOM_CALLCONV I32 Perl_my_stat(pTHX);
PERL_MATHOM_CALLCONV I32 Perl_my_lstat(pTHX);
