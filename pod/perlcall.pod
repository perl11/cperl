...
C<G_ARRAY> flag and the mechanics of accessing the returned items from
the Perl stack.
...
See I<Using G_EVAL> for details on using C<G_EVAL>.
...
shown in the section I<No Parameters, Nothing Returned>) you must
...
Next, we come to C<XPUSHs>. This is where the parameters actually get
