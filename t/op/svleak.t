...
# These leak the gensym'd glob RT #115814, cperl #357.
# Still better than closing the files.
leak 2,2,\&XS::APItest::PerlIO_stderr,'T_INOUT in default typemap';
leak 2,2,\&XS::APItest::PerlIO_stdin, 'T_IN in default typemap';
