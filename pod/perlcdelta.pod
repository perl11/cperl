...
Add support for HEK_STATIC, AvSTATIC, and av_uncow.
...
With many cperl-specific improvements and PERL_CORE specific test changes.

=item Cpanel-JSON-XS 3.0212
...
=item YAML-LibYAML 0.62

A fast and standard YAML en-/decoder. You should not use PP.
With most compiler warnings fixed and PERL_CORE specific test changes.
...
Dave Mitchell started to work on some tasks mentioned in cperl.
