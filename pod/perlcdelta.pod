...
From the remaining exceptions ext/Pod-Html/t was fixed a while ago,
and cpan/IO-Zlib/t with this release.

The remaining exception is for files starting with 0.
