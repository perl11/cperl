...
#define PL_arenas_freed		(my_vars->Garenas_freed)
#define PL_Garenas_freed	(my_vars->Garenas_freed)
#define PL_body_freed		(my_vars->Gbody_freed)
#define PL_Gbody_freed		(my_vars->Gbody_freed)
#define PL_body_freed_size	(my_vars->Gbody_freed_size)
#define PL_Gbody_freed_size	(my_vars->Gbody_freed_size)
...
#define PL_sv_freed		(my_vars->Gsv_freed)
#define PL_Gsv_freed		(my_vars->Gsv_freed)
